...
<html lang="en">
  <head>
    <title>{{App\Setting::where('slug','nama-toko')->get()->first()->description}} | Jasa</title>
    <meta charset="utf-8">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="{{route('depan.home')}}" class="nav-link">Beranda</a></li>
	          ...
	          <li class="nav-item active"><a href="{{route('depan.services')}}" class="nav-link">Jasa</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Beranda <i class="ion-ios-arrow-forward"></i></a></span> <span>Jasa <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Jasa</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-3">Layanan Kami</h2>
                ...
                <p>Melayani kebutuhan transfortasi di upacara pernikahan.</p>
              </div>
            </div>
					</div>
					<div class="col-md-3">
